...
Max Disparity: For general use, set to about 1/10 of the image width.  If you know you are looker only for depths that are further away, you can tweak this accordingly.  It greatly speeds up matching time.
